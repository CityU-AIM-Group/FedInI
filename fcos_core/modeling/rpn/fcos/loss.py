...
from fcos_core.layers import SigmoidFocalLoss, SCELoss, RCELoss, GCELoss, NCEandRCE, NCEandMAE
...
class FCOSLossComputation(object):
    ...
    def __init__(self, cfg):
        self.loss_dict = {'sce': SCELoss, 
                          'rce': RCELoss,
                          'gce': GCELoss, 
                          'apl': NCEandMAE}
        self.cls_loss = cfg.SOLVER.LOSS_FUNC
