...
####################################
_C.SOLVER.TRAIN_FED = True 
_C.SOLVER.METHOD = 'ori'

# ----------------------------Training setting------------------------- #
_C.SOLVER.MAX_ITER = 1500 # Per round local iterations
_C.SOLVER.CONNECT_ROUNDS = 15 # connect rounds
_C.SOLVER.EPOCHS_PER_ROUND = 0 # Deprecated

# ----------------------------Noise setting------------------------- #
_C.SOLVER.ANNOTATIONS = None # 0.2, 0.3, 0.4
_C.SOLVER.IDN = None # 0.75, 0.80

# ----------------------------Method setting------------------------- #
_C.SOLVER.CONNECT_METHOD = None
_C.SOLVER.GRAD = False
_C.SOLVER.BURN_IN_ROUNDS = 6 # Start Label Correction Since BURN_IN_ROUNDS + 1
_C.SOLVER.LARGE_LOSS_TH = 0.3 # The labels with  loss larger than MAX_LOSS * LARGE_LOSS_TH are noisy labels
_C.SOLVER.CP = True
_C.SOLVER.LOSS_FUNC = 'focal'

_C.SOLVER.FEATURE_SHUFFLE = True
_C.SOLVER.ATT_METHOD = "add"
_C.SOLVER.INNER_ON = False
_C.SOLVER.INNER_WEIGHT = 1.0
_C.SOLVER.INTRA_ON = True
_C.SOLVER.INTRA_WEIGHT = 1.0

_C.SOLVER.COSINE_WEIGHT = True
_C.SOLVER.COSINE_SIM_AS_WEIGHT = False
_C.SOLVER.COSINE_ADD = False

# ----------------------------Debug setting------------------------- #
_C.SOLVER.CONNECT_ONLY = False
