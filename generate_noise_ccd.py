...
def generate_sym_noise(VOC_dir, split, sym_noise_percent):
    total_instances = []
    ...
    # make noise dir
    noisy_anno_dir = os.path.join(VOC_dir, 'Noisy_Annotations_seed_{}_per_{:3f}'.format(seed, sym_noise_percent))
...
if __name__ == "__main__":
    generate_sym_noise('./GLRC', "train_fed", 0.1)
    generate_sym_noise('./GLRC', "train_fed", 0.2)
    generate_sym_noise('./GLRC', "train_fed", 0.4)
    generate_sym_noise('./GLRC', "train_fed", 0.5)
